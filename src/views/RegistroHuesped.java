...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Reservas reservas) {
		...
		txtNacionalidad.setBounds(560, 424, 285, 33);
		...
		JLabel lblNumeroReserva = new JLabel("NUMERO DE DOCUMENTO");
		lblNumeroReserva.setBounds(562, 119, 253, 14);
		...
		lblNacionalidad.setBounds(562, 406, 253, 14);
		lblNacionalidad.setForeground(SystemColor.textInactiveText);
		lblNacionalidad.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		contentPane.add(lblNacionalidad);
		
		JLabel lblTelefono = new JLabel("TELÉFONO");
		lblTelefono.setBounds(560, 474, 253, 14);
		...
		txtTelefono.setBounds(560, 495, 285, 33);
